...
function Manage({ offers, setOffers, refreshOffers }: ManageProps) {
  ...
  return <div className="space-y-6">
    ...
    <div className="w-full rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2 2xl:grid-cols-3">{filteredOffers.length ? filteredOffers.map((offer) => <motion.article initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} whileHover={{ y: -4 }} key={offer.id} className="relative overflow-hidden rounded-[22px] border border-[#2967CD]/20 bg-white p-4 shadow-[0_14px_35px_-26px_rgba(0,51,102,0.4)] transition-shadow hover:shadow-[0_20px_42px_-25px_rgba(41,103,205,0.5)]">
